...
class JudgeConfig(UUIDPrimaryKey, TimestampMixin, Base):
    ...
    project = relationship("Project", back_populates="judge_config")
    checklist_items = relationship("ChecklistItem", back_populates="judge_config", cascade="all, delete-orphan")
    eval_dimensions = relationship("EvalDimension", back_populates="judge_config", cascade="all, delete-orphan")
...
class ChecklistItem(UUIDPrimaryKey, Base):
    ...
    judge_config = relationship("JudgeConfig", back_populates="checklist_items")
...
class EvalDimension(UUIDPrimaryKey, Base):
    ...
    judge_config = relationship("JudgeConfig", back_populates="eval_dimensions")
